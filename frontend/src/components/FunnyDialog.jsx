...
const FunnyDialog = ({ theme = "light", onClose }) => {
  ...
  const message = `Tum bohot pyaari ho, or tumhari rare smile to bohot hi pyaari, or upasan naam achha h but kitty us se bhi achha 🤍🌷, I wish tumhare sapne pure ho jaayein!!`;
